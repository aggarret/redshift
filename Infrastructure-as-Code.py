...
'''
Describe the cluseter to see its status
'''
...
'''
 2.2 Take note of the cluster <font color='red'> endpoint and role ARN
'''
...
'''
Opening an incoming TCP port to access the cluser end point
'''
